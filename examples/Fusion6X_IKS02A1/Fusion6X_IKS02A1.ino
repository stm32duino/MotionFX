...
void setup() {
  ...
  AccGyr.begin();
  AccGyr.ACC_SetOutputDataRate((float)ALGO_FREQ);
  AccGyr.ACC_SetFullScale(4);
  AccGyr.GYRO_SetOutputDataRate((float)ALGO_FREQ);
  AccGyr.GYRO_SetFullScale(2000);
  AccGyr.ACC_Enable();
  AccGyr.GYRO_Enable();
  delay(10);
  ...
  MotionFX_CM0P_setOrientation("seu", "seu", NULL);
